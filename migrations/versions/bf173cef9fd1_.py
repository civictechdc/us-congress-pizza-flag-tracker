...
Revision ID: bf173cef9fd1
Revises: 
Create Date: 2021-10-04 16:38:13.281551
...
def upgrade():
    ...
    op.create_index(op.f('ix_offices_uuid'), 'offices', ['uuid'], unique=True)
...
def downgrade():
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_offices_uuid'), table_name='offices')
