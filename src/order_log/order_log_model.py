...
class OrderLogModel(db.Model):
    ...
    order_archived = db.Column(db.Integer, nullable = True)
    ...
    def __init__(self, logUuid, order_number, order_log_count, previous_order_log_uuid, order_uuid, usa_state, home_office_code, order_status_id, order_archived=None):
        self.uuid = logUuid
        ...
        self.order_archived = order_archived
