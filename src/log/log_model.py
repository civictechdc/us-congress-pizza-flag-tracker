...
class LogModel(db.Model):
    ...
    previous_status_code = db.Column(db.String(255))
    ...
    def __init__(self, id, order_number, home_office_code, status_code, order_status_id, active_status, previous_status_code,  status_description, order_updated_at):
        self.id = id
